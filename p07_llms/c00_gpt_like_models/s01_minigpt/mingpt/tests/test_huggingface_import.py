...
Changes: Small modifications made to the original code adjust to repository structure

to run the tests:
`python -m unittest p07_llms.c00_gpt_like_models.s01_minigpt.mingpt.tests.test_huggingface_import`
"""

import unittest
import torch
from p07_llms.c00_gpt_like_models.s01_minigpt.mingpt.model import GPT
from p07_llms.c00_gpt_like_models.s01_minigpt.mingpt.bpe import BPETokenizer
from transformers import GPT2LMHeadModel, GPT2Tokenizer


class TestHuggingFaceImport(unittest.TestCase):
    def test_gpt2(self):
        # This test compares against Hugging Face GPT-2.
        model_type = "gpt2"
